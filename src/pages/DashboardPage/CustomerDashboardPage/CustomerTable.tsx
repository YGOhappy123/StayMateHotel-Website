            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex justify-center">
                        <ConfirmationDialog
                            Trigger={
                                <button disabled={!customer.isActive} className="min-w-fit rounded border-2 border-solid border-red-600 bg-red-100 px-3 py-1.5 text-xs font-medium text-red-600 hover:opacity-90 disabled:cursor-not-allowed disabled:border-gray-600 disabled:bg-gray-100 disabled:text-gray-600 disabled:opacity-50">
                                    Khóa Tài Khoản
                                </button>
                            }
